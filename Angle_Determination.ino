...
const unsigned long printInterval = 5000; // Print interval in milliseconds (5 seconds)
...
void loop() {
  ...
  // Print the positions of all servos to the serial monitor every 5 seconds
  unsigned long currentTime = millis();
  if (currentTime - lastPrintTime >= printInterval) {
    Serial.print("Servo1: "); Serial.print(pos1);
    Serial.print(" Servo2: "); Serial.print(pos2);
    Serial.print(" Servo3: "); Serial.print(pos3);
    Serial.print(" Servo4: "); Serial.println(pos4);
...
void claw() {
  ...
  if(x1>1000) { //if push the right joystick to the left 
    pos4=pos4-3; 
    if(pos4<45) // limit the largest angle when close the claw
      pos4=45;
...
// turn
void turn() {
  if(x2<50) { //if push the right joystick to the left 
    pos1=pos1+3; 
...
// NOTE: This code was extracted from Marco and Jay's group (Servo2: Lower arm, Servo3: Upper arm)